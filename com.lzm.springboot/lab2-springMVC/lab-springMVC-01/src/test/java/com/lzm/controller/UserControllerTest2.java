...
import org.lzm.SpringMVC;
import org.lzm.controller.UserController;
import org.lzm.service.UserService;
...
//@WebMvcTest(UserController.class) @WebMvcTest与@SpringBootTest不能同时存在
@SpringBootTest(classes = SpringMVC.class)
